...
const toBlackAndWhite = (evt) =>{

    evt.target.classList.add("blackAndWhite")
}

sayHelloButton.addEventListener("mouseover", toBlackAndWhite)
...
const notBlackAndWhite = (evt) =>{
    evt.target.classList.remove("blackAndWhite")
}

sayHelloButton.addEventListener("mouseout", notBlackAndWhite)
